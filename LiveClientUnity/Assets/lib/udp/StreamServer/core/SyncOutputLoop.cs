...
namespace StreamServer
{
    public class SyncOutputLoop
    {
        ...
        private ISocketHolder _udpSocketHolder;

        public List<Transform> TransformList = new List<Transform>();

        public SyncOutputLoop(UdpClient udpClient, ISocketHolder udpSocketHolder ,ulong logName)
        {
            udp = udpClient;
        ...
        public void Start()
        {
            ...
            IPEndPoint remoteEndPoint = _udpSocketHolder.GetIPEndPoint();
        ...
        {
            udp.Send(buff, buff.Length, _udpSocketHolder.GetIPEndPoint());
        }
